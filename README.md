...
- **Smart Analysis:** Scans thousands of followers using Neynar API pagination.
- **Mobile Optimized:** "Manage" button uses deep links to open profiles directly in Warpcast.
...
const appUrl = "https://your-project-name.vercel.app";
````
...
```bash
git clone https://github.com/coinisan/farcaster-follow-checker.git
...
**How to get keys:**
  ...
  * **NEYNAR\_API\_KEY:** Go to [Neynar.com](https://neynar.com). Note: A "Starter" plan is recommended.
  * **NEXT\_PUBLIC\_ONCHAINKIT\_API\_KEY:** Go to [Coinbase Developer Platform](https://portal.cdp.coinbase.com/).
